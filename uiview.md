...
> > 旋转，center和bounds值不变，frame值改变。整数顺时针转的
> > 
> > > myView.transform  = CGAffineTransformMakeRotation\(M\_PI\_4\);
> > 
> > 一直旋转
> > 
> > > myView.transform = CGAffineTransformRotate\(myView.transform, M\_PI\_4\/2.0\);
> > 
> > 利用公式完成缩放、平移、旋转
> > 
> > > myView.transform = CGAffineTransformMake\(0.5, 0, 33, 22, 2, 3\);
...
> \[UIView beginAnimations:@"black" context:\(\_\_bridge void\*\)blackView \];
